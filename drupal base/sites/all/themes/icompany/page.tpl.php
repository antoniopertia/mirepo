...
$main_menu1 = $page['main_menu1'];
$main_menu = $page['main_menu'];
$main_menu2 = $page['main_menu2'];
...
<div class="container-fluid theme-border" id="page-wrapper">
	...
	<!--Region Main Menu1-->
	<?php  if($main_menu1){ ?>
	<div id="main_menu1" class="clearfix row-fluid">
		<div id="menu1-inner" class="span12">
			<?php if($main_menu1) print render($main_menu1) ?>	
		</div>
	</div> 		
	<?php  } ?>
	<!---------------------->	
	...
	<!--Menu2-->
	<?php  if($main_menu2){ ?>
	<div id="main_menu2" class="clearfix row-fluid">
		<div id="menu2-inner" class="span12">
			<?php if($main_menu2) print render($main_menu2) ?>	
